...
int
_set_value_rpc_1 (set_value_peticion  *argp, void *result, struct svc_req *rqstp)
{
...
int
_modify_value_rpc_1 (set_value_peticion  *argp, void *result, struct svc_req *rqstp)
{
...
int
_delete_rpc_1 (int  *argp, void *result, struct svc_req *rqstp)
{
	return (delete_rpc_1_svc(*argp, result, rqstp));
}
...
{
	union {
		set_value_peticion set_value_rpc_1_arg;
		int get_value_rpc_1_arg;
		set_value_peticion modify_value_rpc_1_arg;
		int exist_rpc_1_arg;
		int delete_rpc_1_arg;
	} argument;
	union {
		int destroy_rpc_1_res;
		int set_value_rpc_1_res;
		struct get_value_respuesta get_value_rpc_1_res;
		int modify_value_rpc_1_res;
		int exist_rpc_1_res;
		int delete_rpc_1_res;
	} result;
	bool_t retval;
	...
	case set_value_rpc:
		_xdr_argument = (xdrproc_t) xdr_set_value_peticion;
		_xdr_result = (xdrproc_t) xdr_int;
	...
	case get_value_rpc:
		...
		_xdr_result = (xdrproc_t) xdr_get_value_respuesta;
	...
	case delete_rpc:
		_xdr_argument = (xdrproc_t) xdr_int;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (bool_t (*) (char *, void *,  struct svc_req *))_delete_rpc_1;
		break;
